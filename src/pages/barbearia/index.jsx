...
function Barbearia() {
    const { servicosAgenda, barberia } = useContext(DataContext)

    const [barber, setBarber] = useState({})
    useEffect(() => {
        const getBarber = async () => {
            const userBarber = await connectionApi('get', `user`, barberia)
            const companyBarber = await connectionApi('get', `company`, barberia)        
